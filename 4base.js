...
function loadJSOND() {
    ...
    reqw.open( 'GET', 'https://raw.githubusercontent.com/mobilkot/yt/master/rate_russia.json', true );
    //
...

{
    ...
    var soruce2 = ` <div class="yopta_d-table">
            ...
            <div class="yopta_d-tr">
                <div class="yopta_d-td yopta_no-p">
                    <div class="yopta_d-table">
                        <div class="yopta_d-tr">
                            <div class="yopta_d-td">
                                <textarea readonly class="yopta_b_summary_tarif_text" id="yopta_b_tafir_summary_input_tabt" placeholder="Пока ничего не выбрано :( " onmousedown="mDown(this)" onmouseup="mUp(this)" onmouseover="mOver(this)" onmouseout="mOut(this)"></textarea>
                            </div>
                        </div>
                        <div class="yopta_d-tr">
                            <div class="yopta_d-td">
                                <textarea readonly class="yopta_b_summary_tarif_text" id="yopta_b_tafir_summary_input1_tabt" placeholder="  " onmousedown="mDown(this)" onmouseup="mUp(this)" onmouseover="mOver(this)" onmouseout="mOut(this)"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="yopta_d-td yopta_no-p" >
                    <div  id="tapps_tabt" class="divTableCell"  >
                        <div class="divTable">
                            <div class="divTableBody">
                                <div class="divTableRow">
                                    <input id="app-all_tabt" class="input_app-all" type="checkbox" name="select_apps_all_tabt" value="0" onchange="checkAppsTabt(this)">  <label for="app-all_tabt" class="layout-buttons_gb">Все опции и БМП		</span></label>
                                    <div class="divTableCell">
                                   ...
                                   <div class="divTableCell">
                                    ...
                                    <div class="divTableCell">
                                        <input id="app-fb_tabt" class="input_app-fb" type="checkbox" name="select_apps_tabt" value="3" onchange="checkAppsTabt(this)">  <label for="app-fb_tabt" class="layout-buttons"><span> <div data-name="fb" class="b2c-voice-collect__app js-b2c-voice-collect-app b2c-voice-collect__app_active"> <div class="b2c-voice-collect__app-icon"><svg width="35" height="40" viewBox="0 -5 40 40" xmlns="http://www.w3.org/2000/svg">   <circle class="enableflow" fill="#888888" cx="20.5" cy="20.5" r="60"></circle> <circle class="activated" fill="#6781CA" cx="20.5" cy="20.5" r="60"></circle> <path d="M24.4 13.8h2.3v-3.5H23c-4.6 0-4.4 5.3-4.4 5.3v2.6h-3.1v3.5h3.1V31.5h4v-9.8h3.2l.5-3.5h-3.7v-2.6c.1-1.9 1.8-1.8 1.8-1.8z" fill="#FFF"></path> </svg>
                                        <div class="b2c-voice-collect__app-price" data-name="app-social_tabt"   tooltip-position='left'> 20&#8381; </div> </div> </div></span></label>
                                    </div>
                                    <div class="divTableCell">
                                        <input id="app-ok_tabt" class="input_app-ok" type="checkbox" name="select_apps_tabt" value="2" onchange="checkAppsTabt(this)">  <label for="app-ok_tabt" class="layout-buttons"><span> <div data-name="ok" class="b2c-voice-collect__app js-b2c-voice-collect-app b2c-voice-collect__app_active"> <div class="b2c-voice-collect__app-icon"> <svg width="35" height="40" viewBox="0 -5 40 40" xmlns="http://www.w3.org/2000/svg">   <circle class="enableflow" fill="#888888" cx="20.5" cy="20.5" r="60"></circle> <circle class="activated" fill="#FC8924" cx="20.5" cy="20.5" r="60"></circle> <path d="M27.24444 23.7c-.5 1.3-1.7 1.6-3 1.7-.4.2-.9.3-1.4.5.1.2.3.4.4.5l2.7 2.7c.7.8.8 1.8.1 2.5-.7.7-1.7.6-2.5-.1-.8-.9-1.7-1.7-2.6-2.6-.2-.1-.3-.3-.6-.5-.5.6-1 1.1-1.5 1.6-.5.6-1.1 1.2-1.7 1.7-.7.7-1.8.7-2.4 0-.6-.6-.6-1.6.1-2.3.9-.9 1.9-1.8 2.8-2.7l.5-.5c-.8-.3-1.5-.5-2.2-.8-.4-.2-.7-.4-1.1-.6-.8-.5-1.1-1.5-.6-2.3.5-.7 1.5-1 2.4-.5 1.2.7 2.5 1.1 3.9 1.1 1.3 0 2.6-.2 3.7-.9s2.3-.7 3 .9v.6zm-6.7-2.2c-3.3 0-5.8-2.5-5.9-5.8 0-3.1 2.7-5.7 5.9-5.7 3.3 0 5.9 2.6 5.9 5.8 0 3.5-3 5.8-5.9 5.7zm0-8.2c-1.3 0-2.5 1.1-2.5 2.5 0 1.3 1.2 2.4 2.5 2.4 1.4 0 2.5-1.1 2.5-2.5 0-1.3-1.1-2.4-2.5-2.4z" fill="#FFF"></path> </svg>
                                        <div class="b2c-voice-collect__app-price" data-name="app-social_tabt"   tooltip-position='left'> 20&#8381; </div> </div> </div></span></label>
                                    </div>
                                    <div class="divTableCell">
                                        <input id="app-tw_tabt" class="input_app-tw" type="checkbox" name="select_apps_tabt" value="5" onchange="checkAppsTabt(this)">  <label for="app-tw_tabt" class="layout-buttons"><span>  <div data-name="twitter" class="b2c-voice-collect__app js-b2c-voice-collect-app b2c-voice-collect__app_active"> <div class="b2c-voice-collect__app-icon"><svg width="35" height="40" viewBox="0 -5 40 40" xmlns="http://www.w3.org/2000/svg"> <circle class="enableflow" fill="#888888" cx="20.5" cy="20.5" r="60"></circle> <circle class="activated" fill="#55B2F0" cx="20.5" cy="20.5" r="60"></circle> <path d="M31.7 13.94628c-1.1.7-2.1.8-2.1.8 1.7-1.5 1.6-2.4 1.6-2.4-1.3 1-2.5 1.1-2.5 1.1-2.5-2.5-5-1-5-1-3.1 2-2.1 4.8-2.1 4.8-5.2-.3-8.5-4.6-8.5-4.6-1.8 3.8 1.2 5.7 1.2 5.7-.7.1-1.8-.5-1.8-.5.6 4.1 3.3 4.1 3.3 4.1-.5.4-1.8.2-1.8.2 1.3 3.1 3.8 2.8 3.8 2.8-2 2.2-5.8 1.8-5.8 1.8 3.6 2.9 8.7 1.7 8.7 1.7 9.6-2.2 9.1-12.4 9.1-12.4 1.7-.8 1.9-2.1 1.9-2.1z" fill="#FFF"></path> </svg>
                                        <div class="b2c-voice-collect__app-price" data-name="app-social_tabt"   tooltip-position='left'> 20&#8381; </div> </div> </div></span></label>
                                    </div></div>
                                <div class="divTableRow">
                                    <div class="divTableCell">
                                        <input id="app-vi_tabt" class="input_app-vi" type="checkbox" name="select_apps_tabt" value="7" onchange="checkAppsTabt(this)">  <label for="app-vi_tabt" class="layout-buttons"><span>  <div data-name="viber" class="b2c-voice-collect__app js-b2c-voice-collect-app b2c-voice-collect__app_active"> <div class="b2c-voice-collect__app-icon"><svg width="35" height="40" viewBox="0 -5 40 40" xmlns="http://www.w3.org/2000/svg">  <circle class="enableflow" fill="#888888" cx="20.5" cy="20.5" r="60"></circle>  <circle class="activated" fill="#A589D7" cx="20.5" cy="20.5" r="60"></circle> <path d="M30.9861006 14.9555556s1.3 3.8.2 9.9c0 0-.3 6.7-12.5 5.6l-1.8 2c-1.4 1.6-2.5 1.2-2.4-.9l.1-1.7s-4-.7-5.20000001-4.9c-1.1-4.3.5-10 .5-10s.80000001-2.9 3.40000001-3.8c0 0 6.9-2.60000004 14 0 0 0 2.8.9 3.7 3.8zm-1.6 9.3c.9-5.1-.1-8.3-.1-8.4-.7-2.4-3.1-3.1-3.1-3.1-5.9-2.1-11.7 0-11.7 0-2.2.8-2.9 3.2-2.9 3.2s-1.4 4.8-.4 8.4c1 3.6 4.1 4.1 4.1 4.1v3.8c0 .5.2.5.5.2l3.1-3.6c10.2 1 10.5-4.6 10.5-4.6zm-13.8-4.5c-.6-1.2-.9-2.1-.9-2.7 0-.6.2-.8.3-1 .1-.2.9-.6 1-.7.1-.1.8-.2 1 .2.3.4.8 1.1 1.2 1.6.6.8 0 1.3-.2 1.5-.3.4-.4.5-.4.9s1.3 1.8 1.6 2.1c.3.3 1.6 1.5 2 1.5.4.1.9-.4 1.1-.5.6-.4 1-.4 1.3-.3.3.1 1.4 1.2 1.7 1.5.5.4.3.7.3.7s-.7 1.2-.8 1.3c-.1.2-.4.3-1 .3s-1.2-.1-2.8-.9c-1.2-.7-2.4-1.8-3.1-2.4-.5-.5-1.6-1.7-2.3-3.1zm7.3.2c-.2 0-.4-.2-.4-.4-.1-1.5-1.3-1.5-1.4-1.5-.2 0-.4-.2-.4-.4s.2-.4.4-.4c.7 0 2.1.5 2.2 2.3 0 .2-.1.4-.4.4.1 0 0 0 0 0zm1.4.5c-.2 0-.4-.2-.4-.4 0-1.1-.3-2-.9-2.5-.9-.9-2.3-.9-2.3-.9-.2 0-.4-.2-.4-.4s.2-.4.4-.4c.1 0 1.7 0 2.9 1.1.8.7 1.1 1.8 1.1 3.1 0 .3-.1.4-.4.4zm1.4.5c-.2 0-.4-.2-.4-.4 0-1.7-.5-3.1-1.4-4-1.5-1.4-3.7-1.3-3.8-1.3-.2 0-.4-.1-.4-.4 0-.2.1-.4.4-.4.1 0 2.6-.1 4.3 1.5 1.1 1.1 1.7 2.6 1.7 4.5 0 .4-.1.5-.4.5z" fill="#FFF"></path> </svg>
                                        <div class="b2c-voice-collect__app-price" data-name="app-messenger_tabt"   tooltip-position='left'> 20&#8381; </div> </div> </div></span></label>
                                    </div>
                                    <div class="divTableCell">
                                        <input id="app-wh_tabt" class="input_app-wh" type="checkbox" name="select_apps_tabt" value="8" onchange="checkAppsTabt(this)">  <label for="app-wh_tabt" class="layout-buttons"><span>   <div data-name="whatsapp" class="b2c-voice-collect__app js-b2c-voice-collect-app b2c-voice-collect__app_active"> <div class="b2c-voice-collect__app-icon"><svg width="35" height="40" viewBox="0 -5 40 40" xmlns="http://www.w3.org/2000/svg">  <circle class="enableflow" fill="#888888" cx="20.5" cy="20.5" r="60"></circle>  <circle class="activated" fill="#1BD86D" cx="20.5" cy="20.5" r="60"></circle> <path d="M20.2 9C14.1 9 9.1 14 9.1 20.1c0 2.1.6 4 1.5 5.6l-1 3.8-.3 1-.3 1 5.9-1.6c1.6.8 3.3 1.3 5.2 1.3 6.1 0 11.1-5 11.1-11.1C31.3 14 26.4 9 20.2 9zm0 20.4c-1.6 0-3.1-.4-4.4-1.1l-.6-.3-.7.2-2.8.8.7-2.7.2-.7-.4-.7c-.8-1.4-1.3-3-1.3-4.7 0-5.1 4.2-9.3 9.3-9.3 5.1 0 9.3 4.2 9.3 9.3 0 5.1-4.1 9.2-9.3 9.2zm5.2-6.8c-.9-.4-1.7-.9-1.7-.9-.6-.4-1 .2-1 .2-.3.4-.7.8-.7.8-.6.6-1.2.1-1.2.1-2.4-1.4-3.2-2.9-3.2-2.9s-.5-.6.2-1.1c.7-.5.4-1.3.4-1.3l-.7-1.8c-.6-1.4-1.9-.4-1.9-.4-1.4.9-1.1 2.5-1.1 2.5.1.7.7 2 .7 2s.6 1.2 1.8 2.5l.8.8.3.3c.6.5.6.5.9.7 1.6 1.1 3.4 1.3 3.4 1.3 2.5.5 3.5-1.7 3.5-1.7.3-.8-.5-1.1-.5-1.1z" fill="#FFF"></path> </svg>
                                        <div class="b2c-voice-collect__app-price" data-name="app-messenger_tabt"   tooltip-position='left'> 20&#8381; </div>  </div> </div></span></label>
                                    </div>
                                    <div class="divTableCell">
                                        <input id="app-sk_tabt" class="input_app-sk" type="checkbox" name="select_apps_tabt" value="6" onchange="checkAppsTabt(this)">  <label for="app-sk_tabt" class="layout-buttons"><span>   <div data-name="skype" class="b2c-voice-collect__app js-b2c-voice-collect-app b2c-voice-collect__app_active"> <div class="b2c-voice-collect__app-icon"><svg width="35" height="40" viewBox="0 -5 40 40" xmlns="http://www.w3.org/2000/svg"> <circle class="enableflow" fill="#888888" cx="20.5" cy="20.5" r="60"></circle> <circle class="activated" fill="#5DC0FF" cx="20.5" cy="20.5" r="60"></circle> <path d="M31.05408 21.88594c.2-1.2.3-2.5.1-3.6-.9-5.4-6-9.3-11.5-8.5-.3.1-.6 0-.9-.1-2.3-1.2-5.1-.8-7 1-1.8 1.8-2.3 4.6-1.1 6.9.1.2.1.4.1.7-.1.6-.1 1.1-.1 1.7 0 .3 0 .7.1 1 .6 5.9 6 10 11.9 9.1.1 0 .4 0 .5.1 1.1.6 2.3.7 3.5.5 3.9-.7 6.1-4.7 4.5-8.4-.1-.1-.1-.2-.1-.4zm-7.4 4.8c-1.8.5-3.6.5-5.3 0-1.6-.5-2.8-1.5-3.3-3.1-.4-1.2.4-2 1.6-1.9.5.1.9.4 1.1.8.1.3.3.5.4.8.4.9 1.2 1.4 2.1 1.5.8.1 1.6 0 2.3-.3.3-.1.6-.3.7-.6.6-.7.4-1.6-.2-2.1-.7-.5-1.5-.7-2.3-.8-1.1-.2-2.3-.5-3.3-.9-1.1-.5-2-1.2-2.3-2.4-.4-1.5.1-2.6 1.2-3.6 1-.8 2.2-1.1 3.5-1.2h.9c1.2 0 2.3.1 3.4.7.8.4 1.5.9 1.8 1.8.2.4.3.9.1 1.3-.1.5-.5.9-1 1-.6.1-1.1 0-1.5-.5-.1-.2-.4-.5-.5-.8-.5-.8-1.2-1.3-2.2-1.3-.4 0-.9 0-1.3.1s-.7.3-1.1.5c-.5.5-.5 1.2.1 1.7.4.3.8.4 1.3.6 1.1.3 2.2.5 3.3.8.6.1 1.2.4 1.7.7 2.5 1.2 2.3 4.2 1 5.8-.5.6-1.3 1.1-2.2 1.4z" fill="#FFF"></path> </svg>
                                        <div class="b2c-voice-collect__app-price" data-name="app-messenger_tabt"   tooltip-position='left'> 20&#8381; </div>  </div></div></span></label>
                                    </div>
                                    <div class="divTableCell">
                                        <input id="app-tg_tabt" class="input_app-tg" type="checkbox" name="select_apps_off" value="11" onchange="checkAppsTabt(this)">  <label for="app-tg_tabt" class="layout-buttons"><span>   <div data-name="telegram" class="b2c-voice-collect__app_tg js-b2c-voice-collect-app"> <div class="b2c-voice-collect__app-icon_tg"><svg width="35" height="40" viewBox="0 -5 40 40" xmlns="http://www.w3.org/2000/svg">   <circle class="enableflow" fill="#888888" cx="20.5" cy="20.5" r="60"></circle> <circle class="activated" fill="#64ADEB" cx="20.5" cy="20.5" r="60"></circle> <path d="M27.31287 13.03854c-.2 0-.5.1-.7.2-4.8 1.7-9.6 3.4-14.3 5-.6.2-1.2.5-1.3 1.3-.1.7.4 1.2.9 1.6.3.2.5.3.8.4 1.4.7 2.7 1.4 4.1 2 .7.3 1.2.8 1.5 1.5.8 1.6 1.6 3.3 2.4 4.9.3.6.8 1.2 1.6 1.1.8-.1 1.1-.7 1.3-1.4 1.7-4.7 3.3-9.5 5-14.2.1-.4.3-.7.2-1.1.1-.9-.6-1.5-1.5-1.3z" fill="#FCFDFD"></path> </svg>  <div class="b2c-voice-collect__app-price_tg" data-name="tg"   tooltip-position='left'>
                                            <svg width="35" height="15" viewBox="17 3 25 25" xmlns="http://www.w3.org/2000/svg">  <g xmlns="http://www.w3.org/2000/svg" transform=" scale(0.0045)" fill="red" stroke="none">
                                                <path d="M5961 6330 c-18 -4 -409 -386 -627 -612 -34 -35 -99 -100 -145 -145 -46 -45 -109 -108 -140 -140 -31 -32 -67 -68 -80 -80 -13 -11 -86 -83 -161 -160 -75 -76 -317 -318 -538 -538 l-400 -399 0 -413 c0 -402 1 -413 20 -425 11 -7 20 -16 20 -20 0 -3 90 -95 201 -205 111 -109 206 -203 213 -210 139 -143 190 -191 201 -187 7 3 12 -1 12 -9 -2 -18 131 -160 143 -152 6 3 7 -1 4 -9 -3 -9 -3 -16 1 -16 4 0 88 81 186 179 138 138 178 183 173 198 -5 14 -4 15 4 4 8 -11 26 1 86 60 42 41 74 80 71 87 -3 7 0 10 5 7 11 -7 97 71 89 80 -48 52 -563 565 -568 565 -4 0 -15 13 -24 30 -20 33 -14 54 22 80 12 8 21 19 21 25 0 6 13 19 30 28 18 11 27 23 23 32 -4 11 -1 13 13 8 13 -5 16 -3 11 10 -4 11 -1 17 8 17 20 0 52 33 47 48 -2 8 3 10 14 5 14 -5 16 -3 11 11 -4 10 -3 15 3 11 6 -3 13 0 16 8 3 8 15 17 26 20 11 3 17 10 13 16 -3 6 -1 11 4 11 16 0 51 33 51 47 0 7 7 13 15 13 9 0 12 6 8 17 -4 10 -2 14 5 9 14 -8 106 80 97 94 -3 6 1 7 10 4 11 -5 18 0 22 15 3 11 10 21 16 21 16 0 111 103 108 117 -1 8 4 10 14 7 11 -5 18 0 22 15 3 11 9 21 14 21 12 0 109 97 109 110 0 5 5 9 12 8 7 -2 17 7 23 20 5 12 13 22 16 22 12 0 149 137 149 149 0 6 4 11 10 11 15 0 50 42 43 53 -4 6 -1 7 6 2 13 -7 51 26 51 45 0 5 5 10 11 10 11 0 39 24 39 34 0 9 59 66 69 66 5 0 13 9 16 20 4 11 11 18 16 15 5 -4 9 1 9 9 0 9 4 16 10 16 5 0 25 17 45 38 75 79 89 92 97 92 5 0 6 5 3 10 -3 6 0 10 8 10 22 0 41 27 25 33 -9 4 -9 6 2 6 22 1 73 48 65 60 -4 7 0 8 10 5 11 -5 18 0 22 15 3 11 12 21 20 21 8 0 11 5 8 10 -3 6 -1 10 5 10 14 0 79 67 72 75 -3 3 0 5 6 5 5 0 17 2 24 5 9 4 72 -53 168 -149 84 -85 157 -153 162 -150 4 3 8 -1 8 -9 0 -7 14 -27 30 -43 17 -16 59 -58 93 -93 34 -35 73 -73 86 -85 14 -11 38 -35 53 -52 l29 -30 50 47 c36 34 48 51 43 65 -5 15 -4 16 4 4 9 -11 35 10 138 114 100 101 124 130 113 138 -11 8 -10 9 4 4 14 -5 47 21 133 107 63 63 114 120 114 128 -1 8 -19 28 -40 44 -21 17 -39 35 -40 42 0 6 -4 13 -10 15 -10 3 -141 129 -176 169 -11 13 -53 55 -92 92 -40 38 -72 70 -72 72 0 7 -145 145 -152 145 -5 0 -8 6 -8 13 0 8 -10 19 -23 26 -12 6 -31 25 -42 42 -11 16 -26 27 -33 24 -7 -3 -11 -1 -8 4 3 4 -9 22 -27 39 -17 16 -45 44 -60 61 l-29 31 -256 0 c-142 0 -319 2 -394 3 -75 1 -146 0 -157 -3z"/>
                                                <path d="M7719 4775 c-167 -168 -306 -308 -309 -311 -2 -2 135 -144 305 -314 l310 -310 -828 -827 -827 -828 -310 310 -310 310 -305 -305 c-168 -168 -305 -309 -305 -315 0 -6 183 -193 408 -418 l407 -407 420 0 420 0 1028 1028 1027 1028 0 425 0 424 -408 408 c-224 224 -410 407 -413 407 -3 0 -143 -137 -310 -305z"/>
                                                <path d="M5910 4285 l-415 -415 423 -422 422 -423 418 418 417 417 -420 420 c-231 231 -422 420 -425 420 -3 0 -192 -187 -420 -415z"/>
                                ...
                                <div class="divTableRow">
                                    <div class="divTableCell">
                                        <input id="app-yt_tabt" class="input_app-yt" type="checkbox" name="select_apps_tabt" value="9" onchange="checkAppsTabt(this)">  <label for="app-yt_tabt" class="layout-buttons"><span>   <div data-name="youtube" class="b2c-voice-collect__app js-b2c-voice-collect-app b2c-voice-collect__app_active"> <div class="b2c-voice-collect__app-icon"> <svg width="35" height="40" viewBox="0 -5 40 40" xmlns="http://www.w3.org/2000/svg">  <g fill="none" fill-rule="evenodd"> <circle class="enableflow" fill="#888888" cx="20.5" cy="20.5" r="60"></circle> <circle class="activated" fill="#FE2E2E" cx="20.5" cy="20.5" r="60"></circle> <circle class="activated" fill="#path" cx="20.5" cy="20.5" r="60"></circle>  <path fill="#FFF" d="M31.452 16.773s-.216-1.577-.876-2.272c-.838-.912-1.777-.916-2.207-.97-3.084-.231-7.708-.231-7.708-.231h-.01s-4.625 0-7.708.232c-.431.053-1.37.057-2.208.969-.66.695-.875 2.272-.875 2.272s-.22 1.853-.22 3.705v1.736c0 1.853.22 3.705.22 3.705s.214 1.577.875 2.272c.838.912 1.94.884 2.43.979 1.762.176 7.49.23 7.49.23s4.63-.007 7.714-.239c.43-.054 1.37-.058 2.207-.97.66-.695.876-2.272.876-2.272s.22-1.852.22-3.705v-1.736c0-1.852-.22-3.705-.22-3.705z"></path> <path class="activated" fill="#FD2E2E" d="M18.38 24.319v-6.432l5.953 3.227z"></path> </g> </svg>
                                        <div class="b2c-voice-collect__app-price" data-name="app-media_tabt"   tooltip-position='left'> 20&#8381; </div> </div> </div></span></label>
                                    </div>
                                </div>
                                <div class="divTableRow">
                                    <div class="divTableCell">

                                        <input id="app-sm_tabt" class="input_app-sm" type="checkbox" name="select_sms_tabt" value="10" onchange="checkAppsTabt(this)">  <label for="app-sm_tabt" class="layout-buttons"><span>  <div data-name="sms" class="b2c-voice-collect__app js-b2c-voice-collect-app b2c-voice-collect__app_active"> <div class="b2c-voice-collect__app-icon"> <svg width="35" height="40" viewBox="-3 -6 30 30" xmlns="http://www.w3.org/2000/svg" fill="#FFFFFF" stroke="none" >  <circle class="enableflow" fill="#888888" cx="20.5" cy="20.5" r="60"></circle> <circle class="activated" fill="#8cd073" cx="20.5" cy="20.5" r="60"></circle> <path  d="M18,7c0.542,0,1,0.458,1,1v7c0,0.542-0.458,1-1,1h-8H9.171L9,16.171V16H7H6c-0.542,0-1-0.458-1-1V8c0-0.542,0.458-1,1-1H18    M18,5H6C4.35,5,3,6.35,3,8v7c0,1.65,1.35,3,3,3h1v3l3-3h8c1.65,0,3-1.35,3-3V8C21,6.35,19.65,5,18,5z"/> </svg>
                                        <div class="b2c-voice-collect__app-price" data-name="app-sms_tabt"   tooltip-position='left'> 20&#8381; </div> </div> </div></span></label>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div  id="tminute0_tabt" class="divTableCell"  >
                    </div>
                    <div id="tgbite0_tabt" class="divTableCell" >
                    </div>
...
document.getElementById('yopta_tabt').innerHTML=soruce2;
    ...
    switch (type) {
        case "clear":
          /*  document.getElementById("switch-radio-off-2").checked = false;
            ...
            document.getElementById("yopta_tabt").style.display = "none";
        ...
        case "lego":case "plaphone":case "tabt":
            ...
            document.getElementById("yopta_tabt").style.display = "block";
...
var selected_items_tabt = []; //id чекнутых бмп
var cur_mCount, cur_mPrice, cur_gCount, cur_gPrice; //Выбранные минуты,цена,трафик,цена
var cur_mCount_tabt, cur_mPrice_tabt, cur_gCount_tabt, cur_gPrice_tabt; //Выбранные минуты,цена,трафик,цена
...
function summaryOutputTabt() {
    const reducer = (accumulator, currentValue) => accumulator + currentValue;
    var text, text1 = "";
    var cur_sum_app = [];
    var cur_sum = Number(Number(cur_mPrice_tabt) + Number(cur_gPrice_tabt));
    var  gcheck = document.querySelectorAll('input[type="radio"][name="radio_trafic_tabt"]:checked');
    var  mcheck = document.querySelectorAll('input[type="radio"][name="radio_minute_tabt"]:checked');
    var  appcheck = document.querySelectorAll('input[type="checkbox"][name="select_apps_tabt"]:checked');
    var  smscheck = document.querySelectorAll('input[type="checkbox"][name="select_sms_tabt"]:checked');
    var  appall = document.querySelector('input[type="checkbox"][name="select_apps_all_tabt"][value="0"]'); 		//галочка "все"
    if (appcheck.length===0)  selected_items_tabt = [];
    ...
    if (hardToVmode) {
        text = " Выбран пакет:\n  " + cur_mCount_tabt + " минут за " + cur_mPrice_tabt + " рублей\n + " + cur_gCount_tabt + " ГБ за " + cur_gPrice_tabt + " рублей";
        if (smscheck.length === 1) {
            text += "\n + " + unlimApps[10 - 1].name + ". ";
        }

        if (selected_items_tabt.length > 0) {
            selected_items_tabt.forEach(function (item, i, arr) {
                if (unlimApps[item - 1].ids !== 10) {
                    text1 += unlimApps[item - 1].name + ", ";

                }
                cur_sum_app[i] = Number(unlimApps[item - 1].price);
                cur_sum = Number(Number(cur_mPrice_tabt) + Number(cur_gPrice_tabt) + Number(cur_sum_app.reduce(reducer)));
            });
            text += "\nА также безлимитные " + text1 + ".";
    ...
    } else if (!hardToVmode)
    {
        ...
        if (smscheck.length === 1) { cur_sum += Number(unlimApps[10 - 1].price); }
        var gbsclon = declOfNum(cur_gCount_tabt, ['гигабайт', 'гигабайта', 'гигабайт']);
...
//TODO: Шаблонизатор Tov Hard
        ...
        if (cur_mCount_tabt === "0" && cur_gCount === "0" && selected_items_tabt.length === 0 && smscheck.length === 0) { text = `Подключи хоть что-нибудь, ну.. `; }
        else if (cur_mCount_tabt === "0" && cur_gCount_tabt === "0" && selected_items_tabt.length === 0 && smscheck.length === 1) { text += `только безлимитные SMS на всех операторов РФ. `; }
        else if (cur_mCount_tabt !== "0" && cur_gCount_tabt === "0" && selected_items_tabt.length === 0 && smscheck.length === 0) { text += `${cur_mCount_tabt} минут для звонков на других операторов и безлимитные звонки на Yota без интернета.`; }
        else if (cur_mCount_tabt !== "0" && cur_gCount_tabt === "0" && selected_items_tabt.length === 0 && smscheck.length === 1) { text += `${cur_mCount_tabt} минут для звонков на других операторов, безлимитные звонки на Yota, а также безлимитные SMS без интернета.`; }
        else if (cur_mCount_tabt === "0" && cur_gCount_tabt === "0" && selected_items_tabt.length > 0 && smscheck.length === 0) { text += `${unlimpapps}, без дополнительного трафика.`; }
        else if (cur_mCount_tabt === "0" && cur_gCount_tabt === "0" && selected_items_tabt.length > 0 && smscheck.length === 1) { text += `${unlimpapps}, без дополнительного трафика, а также безлимитные SMS.`; }
        else if (cur_mCount_tabt !== "0" && cur_gCount_tabt === "0" && selected_items_tabt.length > 0 && smscheck.length === 0) { text += `${cur_mCount_tabt} минут для звонков на других операторов и безлимитные звонки на Yota, а также ${unlimpapps} без трафика.`; }
        else if (cur_mCount_tabt !== "0" && cur_gCount_tabt === "0" && selected_items_tabt.length > 0 && smscheck.length === 1) { text += `${cur_mCount_tabt} минут для звонков на других операторов и безлимитные звонки на Yota, безлимитные SMS, а также ${unlimpapps} без трафика.`; }
        else if (cur_mCount_tabt === "0" && cur_gCount_tabt !== "0" && selected_items_tabt.length === 0 && smscheck.length === 0) { text += `${cur_gCount_tabt} ${gbsclon} трафика для пользования интернетом.`; }
        else if (cur_mCount_tabt === "0" && cur_gCount_tabt !== "0" && selected_items_tabt.length === 0 && smscheck.length === 1) { text += `${cur_gCount_tabt} ${gbsclon} трафика для пользования интернетом, а также безлимитные SMS.`; }
        else if (cur_mCount_tabt === "0" && cur_gCount_tabt !== "0" && selected_items_tabt.length > 0 && smscheck.length === 0) { text += `${unlimpapps}, а также ${cur_gCount_tabt} ${gbsclon} трафика для остальных целей`; }
        else if (cur_mCount_tabt === "0" && cur_gCount_tabt !== "0" && selected_items_tabt.length > 0 && smscheck.length === 1) { text += `безлимитные SMS, ${unlimpapps}, а также ${_tabtcur_gCount} ${gbsclon} трафика для остальных целей.`; }
        else if (cur_mCount_tabt !== "0" && cur_gCount_tabt !== "0" && selected_items_tabt.length > 0 && smscheck.length === 0) { text += `${cur_mCount_tabt} минут для звонков на других операторов, безлимитные звонки на Yota, а также ${unlimpapps}, ну и ${cur_gCount_tabt} ${gbsclon} трафика для остальных целей.`; }
        else if (cur_mCount_tabt !== "0" && cur_gCount_tabt !== "0" && selected_items_tabt.length > 0 && smscheck.length === 1) { text += `${cur_mCount_tabt} минут для звонков на других операторов, безлимитные звонки на Yota, безлимитные SMS, ${unlimpapps}, ну и ${cur_gCount_tabt} ${gbsclon} трафика для остальных целей.`; }
        else if (cur_mCount_tabt !== "0" && cur_gCount_tabt !== "0" && selected_items_tabt.length === 0 && smscheck.length === 0) { text += `${cur_mCount_tabt} минут для звонков на других операторов, безлимитные звонки на Yota и ${cur_gCount_tabt} ${gbsclon} трафика для пользования интернетом`; }
        else if (cur_mCount_tabt !== "0" && cur_gCount_tabt  !== "0" && selected_items_tabt.length === 0 && smscheck.length === 1) { text += `${cur_mCount_tabt} минут для звонков на других операторов, безлимитные звонки на Yota, безлимитные SMS и ${cur_gCount_tabt} ${gbsclon} трафика для пользования интернетом.`; }
    ...
    if ( (gcheck.length + mcheck.length)  === 2 )  {
        document.getElementById("yopta_b_tafir_summary_input_tabt").innerHTML = text;
        summaryOutput2(selected_items, cur_mCount ,cur_gCount);
    } else {
...
function checkAppsTabt(node) {
    ...
    // Название, группа, базовая стоимость, альт.название
    // [name: "ВК", 			group: "social", 		price: "20", 		altname: "-"]
    appcheck = document.querySelectorAll('input[type="checkbox"][name="select_apps_tabt"]:checked');      //Выбрано среди приложений
    appitems = document.querySelectorAll('input[type="checkbox"][name="select_apps_tabt"]');        		//Все итемы приложжений
    appall = document.querySelector('input[type="checkbox"][name="select_apps_all_tabt"][value="0"]'); 		//галочка "все"
    ...
    if (node.value > appall.value) {
        selected_items_tabt = [];
        appall.checked = (appcheck.length === appitems.length) && (!appall.checked);
        appcheck.forEach(function(item, i, arr) {		if (arr[i].value!==0) selected_items_tabt[i] = arr[i].value; 		});

    }  else  {
        appitems.forEach(function(item, i, arr) {
            appitems[i].checked = !!(appall.checked);
            if ( appall.checked ) {
                selected_items_tabt[i] = arr[i].value;
            }
            else { selected_items_tabt = [];
            }
...
function checkType(node) {
    ...
    //jsondata.elements[0].name
                        ...
                        if (mcheck[0] !== undefined && gcheck[0] !== undefined) {
                            ...
                            cur_mCount = cur_region_teriff.plaphone.mins[mcheck[0].value][0];
                            cur_mPrice = cur_region_teriff.plaphone.mins[mcheck[0].value][1];
                            cur_gCount = cur_region_teriff.plaphone.gbites[gcheck[0].value][0];
                            cur_gPrice = cur_region_teriff.plaphone.gbites[gcheck[0].value][1];
...
//Функция на обновление переменных по выбранному тарифу (plaphone)
function checkTypeTabt(node) {
    var  mcheck, gcheck, gchecks, mchecks;
    gcheck = document.querySelectorAll('input[type="radio"][name="radio_trafic_tabt"]:checked');        //Выбрано среди трафика
    mcheck = document.querySelectorAll('input[type="radio"][name="radio_minute_tabt"]:checked');        //Выбрано среди минут
    gchecks = document.querySelectorAll('input[type="radio"][name="radio_trafic_tabt"]');        //Все итемы в трафике
    mchecks = document.querySelectorAll('input[type="radio"][name="radio_minute_tabt"]');        //Все итемы в минутах
    //cur_mCount = eval(eval("(function () { return \'current_mCount\' })()") + mcheck[0].value);
    //jsondata.elements[0].name
    ...
    if (mcheck[0] !== undefined && gcheck[0] !== undefined) {
        ...
        cur_mCount_tabt = cur_region_teriff.tabt.mins[mcheck[0].value][0];
        cur_mPrice_tabt = cur_region_teriff.tabt.mins[mcheck[0].value][1];
        cur_gCount_tabt = cur_region_teriff.tabt.gbites[gcheck[0].value][0];
        cur_gPrice_tabt = cur_region_teriff.tabt.gbites[gcheck[0].value][1];
...
function addRowTabt(id, region, mins, gbites, sms, snPrice, mePrice, youtube) {
    ...
    apchecks11.forEach(function (item, ids, arr) {
        var dataname = apchecks11[ids];
        if (dataname.getAttribute('data-name') === "app-media_tabt") {
            apchecks11[ids].innerHTML = youtube + "&#8381;";
        } else if (dataname.getAttribute('data-name') === "app-messenger_tabt") {
            apchecks11[ids].innerHTML = mePrice + "&#8381;";
        } else if (dataname.getAttribute('data-name') === "app-social_tabt") {
            apchecks11[ids].innerHTML = snPrice + "&#8381;";
        } else if (dataname.getAttribute('data-name') === "app-sms_tabt") {
            apchecks11[ids].innerHTML = sms + "&#8381;";
        }
    });
    ...
    var elem = document.getElementById("tminute0_tabt");
    while (elem.firstChild) { if (elem.firstChild) elem.removeChild(elem.firstChild);  };

    //TODO: Перестать использовать таблицы, черт
    var tr1 = document.createElement('tr');
    tr1.innerHTML = '<td nowrap id="labletd_tabt"><label class="layout-buttons_gb">Пакеты минут:  </label></td>';
    elem.appendChild(tr1);

    mins.forEach(function(item,i,arr){
        var tr = document.createElement('tr');
        tr.innerHTML = '<td id="tdminute_tabt_' + i + '" nowrap><input value="' + i + '" id="iminute_tabt_'+ i + '"class="input_radio_minute" name="radio_minute_tabt" type="radio" onchange="checkTypeTabt(this)"><label for="iminute_tabt_' + i + '" class="layout-buttons_gb"> ' +  item[0] + ' минут за ' + item[1] + ' рублей  </label></td>';
        elem.appendChild(tr);
    });
    //TODO: Без понятия

    var elem1 = document.getElementById("tgbite0_tabt");
    while (elem1.firstChild) { if (elem1.firstChild) elem1.removeChild(elem1.firstChild);  };

    var tr2 = document.createElement('tr');
    tr2.innerHTML = '<td nowrap id="labletd_tabt"><label class="layout-buttons_gb">Пакеты трафика:  </label></td>';
    elem1.appendChild(tr2);

    gbites.forEach(function(item,i,arr){
        var tr2 = document.createElement('tr');
        tr2.innerHTML = '<td id="tdgbite_tabt_' + i + '" nowrap><input value="' + i + '" id="igbite_tabt_'+ i + '"class="input_radio_gbite" name="radio_trafic_tabt" type="radio" onchange="checkTypeTabt(this)"><label for="igbite_tabt_' + i + '" class="layout-buttons_gb">' +  item[0] + ' ГБ за ' + item[1] + ' рублей' + '</label></td>';
        elem1.appendChild(tr2);
    });
                ...
                regions.forEach(function (item, i, arr) {
                        {
                            ...
                            if (regions[i].id.toString() === customTemplates.getValue(true)) {
                                console.log("Выбран " + customTemplates.getValue(true));
                                addRow('regionTable', regions[i].id, regions[i].plaphone.mins, regions[i].plaphone.gbites, "50", regions[i].plaphone.social,
                                    regions[i].plaphone.messenger, regions[i].plaphone.youtube);
                                addRowTabt('regionTable', regions[i].id, regions[i].tabt.mins, regions[i].tabt.gbites, "50", regions[i].tabt.social,
                                    regions[i].tabt.messenger, regions[i].tabt.youtube);
